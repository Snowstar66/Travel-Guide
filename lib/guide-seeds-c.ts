...
const palmaSeed: CityGuideSeed = {
  ...
  wowFacts: [
    {
      tag: "Katedralen",
      title: "La Seu rymmer bade Gaudi och Miquel Barcelo",
      body: "Mallorcas katedral ar inte fast i ett enda sekel. Den officiella katedralguiden lyfter bade Gaudis stora omgestaltning i borjan av 1900-talet och Miquel Barcelos senare samtida kapell som del av byggnadens identitet.",
      imageUrl: commons("Seu de Mallorca (Palma) - 1.jpg"),
      sourceLabel: "Cathedral of Mallorca",
      sourceUrl: "https://catedraldemallorca.org/en/news/three-conferences-will-cast-light-on-the-most-notable-aspects-of-the-cathedral-of-mallorca-in-the-first-months-of-2022/",
      credit: "Foto via Wikimedia Commons",
    },
    {
      tag: "Ljuset",
      title: "Katedralen far ett eget ljusfenomen tva morgnar om aret",
      body: "Den officiella katedralsidan beskriver hur solljuset den 2 februari och 11 november kastar rosettfonstrets farger mot vaggen under det andra rosefonstren. Palma far ett riktigt wow-ogonblick som bara varar en kort stund.",
      sourceLabel: "Festival of Light",
      sourceUrl: "https://catedraldemallorca.org/en/news/three-conferences-will-cast-light-on-the-most-notable-aspects-of-the-cathedral-of-mallorca-in-the-first-months-of-2022/",
    },
    {
      tag: "Bellver",
      title: "Bellver ar Spaniens enda cirkelformade gotiska borg",
      body: "Visit Palma beskriver Bellver som den enda gotiska borgen i Spanien med cirkular plan. Samtidigt far du 360-gradersvy over bukten och stadens eget historiska museum i samma byggnad.",
      imageUrl: commons("Bellver Castle 2008 Palma Mallorca 176.JPG"),
      sourceLabel: "Visit Palma om Bellver",
      sourceUrl: "https://visitpalma.com/es/dir/castillo-de-bellver/",
      credit: "Foto via Wikimedia Commons",
    },
    {
      tag: "Miro",
      title: "Miros tva ateljer star kvar nastan som han lamnade dem",
      body: "Visit Palma beskriver Taller Sert och Son Boter som en privilegierad inblick i konstnarens arbetsprocess, med verktyg, flackar och kolskisser bevarade i rummen dar han arbetade.",
      imageUrl: commons("Miro's Studio Sert - Palma de Mallorca.jpg"),
      sourceLabel: "Visit Palma om Fundacio Miro",
      sourceUrl: "https://www.visitpalma.com/en/discover/what-to-see-and-what-to-do/essential-experiences/pln523/fundacio-miro-mallorca-miro-and-his-creative-process",
      credit: "Foto via Wikimedia Commons",
    },
    {
      tag: "Modernismen",
      title: "Gran Hotel var Mallorcas forsta moderna hotell",
      body: "Det som i dag ar CaixaForum Palma oppnade 1903 som Gran Hotel. CaixaForum beskriver byggnaden som stadens starkaste modernistiska referenspunkt, ritad av Lluis Domenech i Montaner.",
      imageUrl: commons("Gran Hotel.JPG"),
      sourceLabel: "CaixaForum Palma",
      sourceUrl: "https://caixaforum.org/es/palma/el-edificio",
      credit: "Foto via Wikimedia Commons",
    },
    {
      tag: "Medina",
      title: "Arab Baths ar ett av de tydligaste sparen av Medina Mayurqa",
      body: "De ar relativt sma, men Visit Palma beskriver dem som ett av de stora arven fran muslimsk arkitektur pa Mallorca. Just darfor blir de ofta starkare som stadslager an som klassisk sevardhet.",
      sourceLabel: "Visit Palma om Arab Baths",
      sourceUrl: "https://www.visitpalma.com/es/descubrir/que-ver-y-que-hacer/cultura/pln515/banos-arabes",
    },
  ],
  gallery: [
    {
